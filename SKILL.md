...
| **Visual Quality Check** | **`workflows/visual-quality-check.md`** | **Post-SVG visual quality inspection (contrast/whitespace/alignment)** |
...
| Hermes runtime notes | `references/hermes-runtime.md` |
| html-ppt integration | `references/html-ppt-integration.md` | html-ppt-skill 核心资产分析、runtime.js 功能拆解、对接方案、Windows 克隆替代方案 |
